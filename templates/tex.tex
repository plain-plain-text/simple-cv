...
$if(fonts.regular)$
\setmainfont{$pdf-fonts.regular$.otf}[%
  $if(pdf-fonts.italic)$
  ItalicFont = $pdf-fonts.italic$.otf ,
  $endif$
  $if(pdf-fonts.bold)$
  BoldFont = $pdf-fonts.bold$.otf ,
  $else$ % The default is not to have a bold font defined…
  BoldFont = $pdf-fonts.regular$.otf ,
  $endif$
  $if(pdf-bold-as-smallcaps)$
  BoldFeatures = {Letters=SmallCaps} ,
  $endif$
  $if(pdf-fonts.smallcaps)$
  SmallCapsFont = $pdf-fonts.smallcaps$.otf ,
  $endif$
  Path =./fonts/ ,
  Ligatures=Historic ,
  Ligatures=Rare ,
...
$endif$
$if(pdf-fonts.monospace)$
\setmonofont{$pdf-fonts.monospace$.otf}[
  Path =./fonts/
]
$endif$
...
$if(footer)$
  \makeoddhead{chapter}{}{}{}
  \makeoddfoot{chapter}{}{}{%
    $if(footer.display-author)$$for(format.author)$$format.author$$sep$, $endfor$,$endif$  $if(footer.last-modified)$\today,$endif$ \thepage}
$else$
  \makeoddhead{chapter}{}{}{}
